...
```javascript
isIndexMode = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-assert-is-index-mode@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-assert-is-index-mode@umd/bundle.js"></script>
```
